...
const FundDividend: React.FC = () => {
  ...
  const stats = {
    ...
    avgDividendPerFund: filteredData.length > 0
    ...
    },
    {
      ...
      render: (value: number) => (
        <span style={{ color: '#f5222d', fontWeight: 500 }}>
          {value > 0 ? `¥${value.toLocaleString('zh-CN', { maximumFractionDigits: 2 })}` : '-'}
        </span>
      ),
    },
    {
    ...
    <div style={{ padding: '24px', minHeight: '100vh', background: '#f5f5f5' }}>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h1 style={{ margin: 0, fontSize: '24px', color: '#fff', fontWeight: 600 }}>
              基金分红排名
            </h1>
